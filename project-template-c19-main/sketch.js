...
function draw() {
  ...
  text("Pressione a Seta Para Cima para Reiniciar o jogo!"); //OLHAR AQUI SE ALGO DER ERRADO
...
function reset(){
 ...
 redCyclists.destroyEach();  //OLHAR AQUI SE ALGO DER ERRADO
 yellowCyclists.destroyEach();  //OLHAR AQUI SE ALGO DER ERRADO
 pinkCyclists.destroyEach();  //OLHAR AQUI SE ALGO DER ERRADO

 mainCyclist.changeAnimation("collide", mainRacerImg2);
 distance = 0;
}
